...
import { libraries } from "./gulp/tasks/libraries.js"
...
function watcher() {
    ...
    gulp.watch(path.watch.libraries, libraries);
    gulp.watch(path.watch.js, javascript);
}

const mainTasks = gulp.parallel(copy, libraries, html, scss, javascript);
